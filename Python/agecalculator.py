...
if __name__ == '__main__':
    ...
    dob = Label(root, bg = 'green')

    #Create the Given Date : Label
    givenDate = Label(root, text= "Today's Date", bg = 'blue')

    #Create the Given Date : Label
    birthDate = Label(root, text='Birth Date', bg = 'blue')

    # Create a Day : label 
    day = Label(root, text = 'Day', bg = 'white')

    # Create a Month : label 
    month = Label(root, text = 'Month', bg = 'white')

    # Create a Year : label 
    year = Label(root, text = 'Year', bg = 'white')

    # Create a Given Day : label 
    givenDay = Label(root, text = "Day", bg = "white")

    # Create a Given Month : label 
    givenMonth = Label(root, text = "Month", bg = "white")

    # Create a Given Year : label 
    givenYear = Label(root, text = "Year", bg = "white")

    # Create a Years : label 
    rsltYear = Label(root, text = "Years", bg = "white")

    # Create a Month : label 
    rsltMonth = Label(root, text = "Month", bg = "white") 

    # Create a Days : label 
    rsltDay = Label(root, text = "Days", bg = "white")
